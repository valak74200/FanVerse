...
const Waves: React.FC<WavesProps> = ({
  ...
  useEffect(() => {
    ...
    function drawLines() {
      ...
      // Créer un dégradé dynamique pour les lignes
      const gradient = ctx.createLinearGradient(0, 0, width, height);
      gradient.addColorStop(0, 'rgba(255, 99, 71, 0.3)');
    ...
    <div
      ...
      style={{
        ...
        background: backgroundColor.includes('gradient') 
          ? backgroundColor 
          : `radial-gradient(circle at 30% 20%, rgba(255, 99, 71, 0.1) 0%, transparent 50%), radial-gradient(circle at 70% 80%, rgba(0, 255, 255, 0.1) 0%, transparent 50%), ${backgroundColor}`,
        ...style,
      }}
    >
