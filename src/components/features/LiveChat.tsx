...
import { Send, Mic, MicOff, Volume2, Smile, ImageIcon, Crown, MessageCircle } from "lucide-react"
...
export function LiveChat({ 
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header du chat */}
      <Card className="bg-gradient-to-r from-gray-900/95 via-black/90 to-gray-800/95 border-purple-500/30 p-4 mb-4">
      ...
      {/* Messages */}
      <Card className="flex-1 bg-gray-900/95 border-gray-800 p-4 overflow-hidden">
      ...
      {/* Zone de saisie */}
      <Card className="bg-gray-900/95 border-gray-800 p-4 mt-4">
        <div className="flex items-center space-x-2">
