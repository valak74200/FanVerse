...
const Waves: React.FC<WavesProps> = ({
  ...
  const linesRef = useRef([] as Point[][]);
  ...
  const frameIdRef = useRef(null as number | null);
  ...
  useEffect(() => {
    ...
    (window as any).addEventListener("touchmove", handleTouchMove, { passive: false });

    return () => {
      // Nettoyer les event listeners
      (window as any).removeEventListener("resize", handleResize);
      (window as any).removeEventListener("mousemove", handleMouseMove);
      (window as any).removeEventListener("touchmove", handleTouchMove);
