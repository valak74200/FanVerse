  ...
  return (
    <group ref={panelRef} position={position}>
      ...
      <mesh position={[0, 0, -0.1]}>
        ...
        <meshStandardMaterial color="#1a1a1a" transparent opacity={0.9} side={THREE.DoubleSide} />
      </mesh>
      ...
      {/* Emotion Buttons */}
      <Text position={[-3, 1.5, 0]} fontSize={0.25} color="#888888" anchorX="left" anchorY="middle">
        EMOTIONS:
      </Text>

      {emotions.map((emotion, index) => (
        <group key={emotion.id} position={[-2.5 + index * 1.5, 0.8, 0]}>
          <mesh
          ...
          <Text position={[0, 0, 0.01]} fontSize={0.3} color="#ffffff" anchorX="center" anchorY="middle">
            {emotion.emoji}
          </Text>
          <Text position={[0, -0.7, 0]} fontSize={0.15} color="#ffffff" anchorX="center" anchorY="middle">
            {emotion.label}
          </Text>
        </group>
      ))}
      ...
      {/* Camera View Buttons */}
      <Text position={[-3, -0.5, 0]} fontSize={0.25} color="#888888" anchorX="left" anchorY="middle">
        CAMERA:
      </Text>

      {cameraViews.map((view, index) => (
        <group key={view.id} position={[-2.5 + index * 1.5, -1.3, 0]}>
          <mesh
          ...
          >
            ...
            <meshStandardMaterial color={hoveredButton === view.id ? "#3b82f6" : "#404040"} transparent opacity={0.9} />
          </mesh>
          <Text position={[0, 0, 0.06]} fontSize={0.12} color="#ffffff" anchorX="center" anchorY="middle">
            {view.label}
          </Text>
        </group>
      ))}
      ...
      <group position={[0, -2.3, 0]}>
        ...
        >
          ...
          <meshStandardMaterial color={hoveredButton === "exit" ? "#ef4444" : "#666666"} transparent opacity={0.9} />
        </mesh>
        <Text position={[0, 0, 0.06]} fontSize={0.2} color="#ffffff" anchorX="center" anchorY="middle">
          EXIT VR
        </Text>
      </group>
    </group>
